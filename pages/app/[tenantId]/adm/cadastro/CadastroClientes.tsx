...
export default function CadastroClientes() {
  ...
  const [showPopUpClientes, setShowPopUpClientes] = useState(false);

  const handleNewCliente = () => {
    setShowPopUpClientes(true);
  };
      ...
      <div className=" h-screen overflow-y-scroll dark:text-gray-400 dark:bg-gray-600 bg-gray-100 pl-60 pt-16 pr-4">
        <div className="flex justify-between mt-1 items-center">
          <div className="flex items-center py-4">
            ...
            <h3 className=" ml-3 pt-1 font-normal text-gray-500 ">
              <p className="hover:text-sky-600 cursor-pointer dark:text-gray-400 dark:bg-gray-600">
                / Cadastros
              </p>
            </h3>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <AddCliente //@ts-ignore
            show={showPopUpClientes} //@ts-ignore
            setShow={setShowPopUpClientes}
          />
          <Filtro />
          <TabelaClientes />
        </div>
