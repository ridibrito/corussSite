...
const AppIndex = () => {
    ...
    <div className="flex justify-center mt-12 bg-sky-600 rounded max-w-md mx-auto text-white items-center py-3">

       
            <svg aria-hidden="true" className="mr-2 w-8 h-8 text-gray-200 animate-spin dark:text-gray-600 fill-sky-600" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
