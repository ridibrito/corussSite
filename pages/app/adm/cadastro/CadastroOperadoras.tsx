...
export default function Operadora() {
  const [showPopUpOperadora,setShowPopUpOperadora ] = useState(false)

const handleNewOperadora = () => {
  setShowPopUpOperadora(true);
}
  ...
  return (
    <>
      ...
      <div className=" h-screen overflow-y-scroll  bg-gray-100 pl-60 pt-16 pr-4">
        ...
        <div>
        <button onClick={handleNewOperadora} className='flex items-center ml-60 bg-sky-600 text-white px-6 py-2 font-normal mr-3 rounded shadow'>Incluir cadastro +</button>
        ...
        <div >
          ...
          <AddOperadoras
            show ={showPopUpOperadora}
            setShow={setShowPopUpOperadora}
          />
          <Filtro />
          <Tabela1 />
        </div>
