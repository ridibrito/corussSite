...
export default function Footer(){
    ...
    <div className="mx-auto max-w-screen-xl">
        ...
        <div className="sm:flex sm:items-center sm:justify-between">
            <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2022 <a href="https://flowbite.com" className="hover:underline">coruss</a>. Todos od direitos reservados.
            </span>
