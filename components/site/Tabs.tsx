        ...
        <div className=" p-10 py-8 px-4 mx-auto max-w-screen-2xl sm:py-16 lg:px-6">
          <div className="max-w-screen-md mb-8 lg:mb-16">
            <h2 className="mb-4 text-5xl tracking-tight font-extrabold text-gray-700 dark:text-white">
              Uma coleção de ferramentas criadas pensando no crescimento da
              receita.
            </h2>
            <p className="text-gray-500 sm:text-xl dark:text-gray-400">
              Cada ferramenta é uma solução poderosa. Usadas em conjunto, são a
              evolução do seu negócio de planos de saúde.
            </p>
            <button className="bg-sky-600 font-semibold rounded px-10 py-3 text-white mt-2">
          ...
          <div className="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
            <div>
              ...
              <p className="text-gray-500 dark:text-gray-400">
                Um painel completo para rápida visualização de todas as
                principais métricas, ajudando o consultor a tomar melhores
                decisões.
              </p>
              <Link href="/dashboardSite">
                <p className="text-sky-600 text-sm cursor-pointer">
                  Saiba mais...
                </p>
              </Link>
            </div>
            <div>
              <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-sky-100 lg:h-12 lg:w-12 dark:bg-sky-900">
                <svg
                  ...
                  viewBox="0 0 24 23"
                >
                  <path d="M22 2h-20v13h20v-13zm-2 11h-16v-9h16v9zm2 3h-20l-2 6h24l-2-6zm-12.228 5l.466-1h3.524l.466 1h-4.456z" />
                </svg>
              </div>
              <h3 className="mb-2 text-xl font-bold dark:text-white">CRM</h3>
              <p className="text-gray-500 dark:text-gray-400">
                Planejamento e organização. Simples e fácil de usar, tenha
                visibilidade e controle sobre seus processos, e ganhe
                produtividade para aumentar as vendas.
              </p>
              <Link href="/crmSite">
                <p className="text-sky-600 text-sm cursor-pointer">
                  Saiba mais...
            ...
            <div>
              ...
              <p className="text-gray-500 dark:text-gray-400">
                O Adm Coruss é uma funcionalidade essêncial, aqui você cadastra
                clientes, locais de entrega de produção, gera relatórios e muito
                mais.
              </p>
              <Link href="/admSite">
                <p className="text-sky-600 text-sm cursor-pointer">
            ...
            <div>
              ...
              <p className="text-gray-500 dark:text-gray-400">
                Sistema financeiro completo, faça lançamentos de comissões,
                bonificações e organize inclusive suas contas pessoais.
              </p>
              <Link href="/financeiroSite">
                <p className="text-sky-600 text-sm cursor-pointer">
                  Saiba mais...
                </p>
              </Link>
            ...
            <div>
              ...
              <p className="text-gray-500 dark:text-gray-400">
                API WhatsApp para atendimento direto dentro da plataforma,
                cadastre respostas automáticas, chatboot e potencialize os
                resultados.
              </p>
              <Link href="/whatsappSite">
                <p className="text-sky-600 text-sm cursor-pointer">
                  Saiba mais...
                </p>
              </Link>
            ...
            <div>
              ...
              <p className="text-gray-500 dark:text-gray-400">
                Simulador Coruss gratuito, gere cotações rapidamente dentro da
                plataforma e mande para o CRM automaticamente.
              </p>
              <br></br>
              <Link href="/simuladorSite">
                <p className="text-sky-600 text-sm cursor-pointer">
                  Saiba mais...
                </p>
              </Link>
