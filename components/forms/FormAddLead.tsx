  ...
  return (
    <>
      <div
        ...
        className="bg-white shadow-2xl fixed rounded-lg mt-2 dark:bg-gray-800  dark:text-gray-400 z-10 flex-col px-8 py-5 right-4 transition-all duration-500"
      >
        <div>
          <div className="relative p-4 w-full max-w-2xl h-full md:h-auto">
            <div className="relative  bg-white dark:bg-gray-800 sm:p-5">
